...
"""
Use this component to generate ENVI-Met terrain for "LB ENVI-Met Spaces".
-
...
ghenv.Component.Name = "Ladybug_ENVI-Met Terrain"
ghenv.Component.NickName = 'ENVI-MetTerrain'
...
from envimetObj import geometry
################################################
...
def main():
    if _terrain:
        terrain = geometry.terrainGeometry(_terrain)
        return terrain
    return None
